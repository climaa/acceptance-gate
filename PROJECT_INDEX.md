...
- Workspace suites, all in the `test` gate job: `packages/ui` 28 files / 432 tests (70% coverage floor), `apps/blog` 12 / 287, `packages/visual-diff` 10 / 302, `apps/storybook` 4 / 99, `apps/visual-diff-ui` 30 / 512
