...
And this is not a suite I run when I remember to. It is a [required job in the merge gate](https://storybook.carloslima.dev/index.html?path=/docs/docs-devops-the-gate--docs), alongside type checking, lint, unit tests and the visual diff. No branch reaches `main` without it.
