...
Nobody wrote a bad workflow. What the new repository started from was this repository's workflow, unchanged, and it has run here for months at no cost.
...
By the end of the 3rd, the `pr` workflow in the new repo was one gate made of twelve jobs — ten came over with the copy, and the two commits above added the eleventh and twelfth. Seven of them are a matrix:
