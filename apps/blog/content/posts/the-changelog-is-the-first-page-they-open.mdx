...
The headline of **v1.3.0**, the release this post was written against, is short: **the visual-diff console has an end-user manual, and it cannot drift from what it describes.**
