    ...
    <Stack gap={8}>
      ...
      <Prose>
        ...
        <p>
          ...
          components, designing accurate CI pipelines, and developing my own quality tools. 
          Recently, I&apos;ve been considering how these aspects shift when an agent contributes 
          to the code.
        </p>
        <p>
          ...
          in three months, with teams across Argentina, Mexico, the US. 
          `acceptance-gate` — this blog, its design system, its CI gate, a tagged v1.0.0 
          — took a week. Along the way I&apos; ve built proofs-of-concept at several companies 
          whose whole job was to answer a question fast enough that the answer still mattered.
        </p>
        <p>
          That&apos;s also where the interest in verification comes from. Building fast is the
          easy half. The hard half is knowing which of the things you built you&apos;re allowed 
          to trust—and that question gets sharper, not softer, when an agent is writing the code.
        </p>
        <h2>Contact</h2>
        <p>
