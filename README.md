...
| `apps/visual-diff-ui` — the console that reviews those runs     | ✅ [published](https://acceptance-gate-visual-diff-ui.vercel.app) — the visual-diff review console in sample mode: the #242 regression report, browsable; the run panel lands by issue |
