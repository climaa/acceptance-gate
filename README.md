...
| `designs/` — the design source of truth + PNG exports           | ✅ normative component inventory, two theme personalities, four exported boards incl. the visual-diff console pages                                |
