...
| `apps/blog` — Next.js 16 App Router + MDX, consumes `@gate/ui`            | ✅ [published](https://blog.carloslima.dev) — posts, tags, RSS, sitemap, OG images, Cache Components + Partial Prefetching, error boundaries reporting to Bugsink                                                                                                                                                                                                                                      |
